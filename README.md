...
- file install **chính** là: `https://raw.githubusercontent.com/NVIDIA/NemoClaw/refs/heads/main/install.sh`
- file `standalone-api/install.sh` chỉ là file **cài thêm / helper** cho wrapper này
- wrapper không thay thế installer chính của NemoClaw
...
- Install: đọc metadata installer chính, xem thông tin URL chính, hoặc trigger installer chính qua API
...
- installer chính được coi là file raw GitHub ở trên; file `standalone-api/install.sh` chỉ là helper phụ.
